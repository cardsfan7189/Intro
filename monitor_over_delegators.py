...
if frozen_deposit_limit < delegator_balance_limit:
    staking_capacity = frozen_deposit_limit
else:
    staking_capacity = delegator_balance_limit
...
if staking_balance > staking_capacity and staking_balance > prev_staking_balance and prev_status == "Not Overdelegated":
    ...
    update_last_level(s3,"/tmp/last_level.txt",current_level,"Overdelegated",staking_balance)
else:
    #exit(0)
    ...
    update_last_level(s3,"/tmp/last_level.txt",current_level,indicator,staking_balance)
